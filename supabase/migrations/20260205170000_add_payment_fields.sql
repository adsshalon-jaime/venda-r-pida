...
COMMENT ON COLUMN sales.payment_method IS 'Método de pagamento: dinheiro, pix, cartao ou fiado';
...
COMMENT ON COLUMN sales.payment_due_date IS 'Data de vencimento para pagamentos fiado (até 30 dias)';
